<template>
  <div class="app-container">
    ...
    <!-- Table -->
    <el-tabs v-model="coinType" type="border-card" @tab-click="getBuyExchange">
...
<script>
import { getBuyExchange, remark } from '@/api/trade'
import { CoinTypes, TradeStatusTypes } from '@/utils/enums'

const modelName = 'BuyTransaction'
...
export default {
  ...
  methods: {
    getBuyExchange() {
      ...
      getBuyExchange(params).then(res => {
